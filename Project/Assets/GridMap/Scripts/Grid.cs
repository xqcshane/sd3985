...
public class Grid {
    ...
    public Grid(int width, int height, float cellSize, Vector3 originPosition) {
        ...
        gridBoolArray = new bool[width, height];
        //gridBoolArray = true;
        ...
        if (showDebug) {
            ...
            for (int x = 0; x < gridArray.GetLength(0); x++) {
                for (int y = 0; y < gridArray.GetLength(1); y++) {
                    ...
                    debugTextArray[x, y] = UtilsClass.CreateWorldText(gridBoolArray[x, y].ToString(), null, GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * .5f, 1, Color.white, TextAnchor.MiddleCenter);
